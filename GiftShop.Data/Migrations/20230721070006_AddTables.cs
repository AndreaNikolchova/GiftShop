        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProduductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomOrders_CustomProducts_ProduductId",
                        column: x => x.ProduductId,
                        principalTable: "CustomProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomOrders_DeliveryCompanies_DeliveryCompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_YarnTypes_YarnTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomOrders_DeliveryCompanyId",
                table: "CustomOrders",
                column: "DeliveryCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomOrders_ProduductId",
                table: "CustomOrders",
                column: "ProduductId");
